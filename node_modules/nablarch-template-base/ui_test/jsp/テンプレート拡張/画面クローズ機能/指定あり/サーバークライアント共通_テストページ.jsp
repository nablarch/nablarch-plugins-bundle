...
<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    ...
    <div id="mock"></div>
    <div>
      <span class="testcase default">nablarch_windowClose, イベント定義と一致しない場合はウィンドウはクローズしない</span>
      <button:block>
        <button class="" type="button">動作しない</button>
        <a href="#" class="">指定なし</a>
      </button:block>
    </div>
    <div>
    ...
    <div>
      <span class="testcase eventDef">イベント定義と一致する場合は閉じる</span>
      <button:block>
