...
import nablarch.common.handler.threadcontext.*;
...
public class AppServer {
    ...
    public static final void main(String[] args) {
        ...
        new HttpServer()
                ...
                .setPort(portNum)
                .addHandler("//*.jsp", new HttpCharacterEncodingHandler())
                .addHandler("//*.jsp", new GlobalErrorHandler())
                .addHandler("//*.jsp", new ThreadContextClearHandler())
                .addHandler(new HttpResponseHandler())
                .addHandler("//*.jsp", new SecureHandler())
                .addHandler("//*.jsp", new ThreadContextHandler().setAttributes(
                ...
                .addHandler("//*.jsp", new HttpAccessLogHandler())
                .addHandler(new MultipartHandler())
                .addHandler("//*.jsp", new SessionStoreHandler())
                .addHandler("//*.jsp", new NormalizationHandler())
                .addHandler("//*.jsp", new ForwardingHandler())
                .addHandler("//*.jsp", new HttpErrorHandler())
