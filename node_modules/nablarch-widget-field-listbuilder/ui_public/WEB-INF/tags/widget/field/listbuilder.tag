...
<n:set var="readonly_class" value="${(readonly) ? 'nablarch_readonly' : ''}" scope="page"/>
<n:set var="labelPattern" value="${(empty elementLabelPattern) ? '$LABEL$' : elementLabelPattern}" scope="page"/>
