...
(function(document, require) { "use strict";
  ...
  if (typeof require === 'function') {
    ...
    require(['jquery', 'devtool/Main'], function($, Main) {
      $(function() {
        // ローカルレンダリングを機能させるために、jQuery 3.5.0より前のバージョンと挙動を合わせる。
        // (挙動の合わせ方は、jQuery Core 3.5 Upgrade Guide(https://jquery.com/upgrade-guide/3.5/)の「jQuery.htmlPrefilter changes」の項を参照)
