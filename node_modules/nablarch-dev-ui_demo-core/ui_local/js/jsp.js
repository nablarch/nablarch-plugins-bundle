 ...
 * @since  1.3
 */
define(['jquery', 'jsp/context', 'jsp/el', 'devtool/jsp_verifier','sugar'],
function($, topContext, el, verifier) { 'use strict';
  ...
  function jquery_jsp(src, moduleName) {
    var comment   = /<%--[\s\S]*?--%>/g
      ...
      , tags      = ['(?:[_a-zA-Z]+:[_a-zA-Z]+)'
                    , 'title', 'style', 'table','thead','tbody','tfoot', 'tr', 'td', 'th', 'script', 'select'].join('|')
