  ...
  <n:form>
    <tab:group name="test">
      ...
      <tab:content title="サーバサイド・クライアントサイド共通" value="sc" selected="true">
        ...
        <span class="test-case showTitle-test">showTitle属性を指定しない場合はテーブルタイトルが表示される。</span>
        <table:plain
            title="showTitle未指定"
            resultSetName="result"
            sampleResults="4"
        ...
        <span class="test-case showTitle-test">showTitle属性=ブランクの場合はテーブルタイトルが表示される。</span>
        <table:plain
            title="showTitleブランク"
            resultSetName="result"
            sampleResults="4"
        ...
        <span class="test-case showTitle-test">showTitle=trueの場合はテーブルタイトルが表示される。</span>
        <table:plain
        ...
        <span class="test-case showTitle-test">showTitle=falseの場合はテーブルタイトルが表示されない。</span>
        <table:plain
        ...
        <span class="test-case">
          ※ ローカルレンダリング使用時の確認項目<br/>
          ローカルレンダリングでtheadタグ、tbodyタグ、tfootタグがエミュレートされ、HTMLに出力されていることを確認する。<br/>
          <ul>
            <li>theadタグの確認方法</li>
        	  テーブルのヘッダが<font color="red">赤の枠線</font>で囲まれていること
            <li>tbodyタグの確認方法</li>
              テーブルのボディが<font color="blue">青の枠線</font>で囲まれていること
            <li>tfootタグの確認方法</li>
              テーブルのフッタが<font color="green">緑の枠線</font>で囲まれていること
          </ul>
        </span>
        <style type="text/css">
          div#thead_tbody_tfoot table > thead > tr > th {
            border: 2px #ff0000 solid;
          }

          div#thead_tbody_tfoot table > tbody > tr > td {
            border: 2px #4169e1 solid;
          }

          div#thead_tbody_tfoot table > tfoot > tr > td {
            border: 2px #008000 solid;
          }
        </style>
        <table:plain_test
                title="thead,tbody,tfootが利用できること"
                resultSetName="result"
                sampleResults="4"
                id="thead_tbody_tfoot">
          <column:label
                  key="id"
                  title="ユーザID"
                  sample="001|002">
      ...
      <tab:content title="サーバサイド" value="s">
        ...
        <span class="test-case resultNumName-test">
          resultNumName属性を指定
        </span>
        <table:plain
            title="resultNumName属性"
            resultNumName="resultNum">
            <column:label key="test" title="テスト" value="test">
            </column:label>
        </table:plain>
      </tab:content>
    </tab:group>
