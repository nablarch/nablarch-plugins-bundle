...
<n:set var="labelValue" value="" scope="page"/>
<n:set var="labelId" name="${idName}" scope="page"/>
<n:set var="labelName" name="${valueName}" scope="page"/>
  ...
  <jsp:attribute name="fieldContent">
    <c:if test="${not empty labelId}">
      <n:set var="labelValue"
          value="${labelId}:${labelName}" scope="page"/>
    </c:if>
