...
<%@ taglib prefix="link" tagdir="/WEB-INF/tags/widget/link" %>
    ...
    <h3 id="view"
      ...
      <ul class="menu_folder
        ...
        <li class="hover">
          <link:submit
              uri="/jsp/メニュー/index.jsp"
              dummyUri="/jsp/メニュー/index.jsp"
              label="">
      ...
      <ul class="menu_folder
                 -title buttonLinks">
          <li class="hover"><link:submit uri="/jsp/ボタン/検索ボタン.jsp" dummyUri="/jsp/ボタン/検索ボタン.jsp" label="検索"/></li>
      </ul>
      ...
      <ul class="menu_folder
                 ...
                 sub_folder">
          <li class="hover"><link:submit uri="/jsp/ボタン/戻るボタン.jsp" dummyUri="/jsp/ボタン/戻るボタン.jsp" label="戻るボタン"/></li>
          <li class="hover"><link:submit uri="/jsp/ボタン/キャンセルボタン.jsp" dummyUri="/jsp/ボタン/キャンセルボタン.jsp" label="キャンセルボタン"/></li>
      </ul>
      <h3 id="buttonLinks_update"
       ...
       <ul class="menu_folder
                 ...
                 sub_folder">
          <li class="hover"><link:submit uri="/jsp/ボタン/確認ボタン.jsp" dummyUri="/jsp/ボタン/確認ボタン.jsp" label="確認ボタン"/></li>
          <li class="hover"><link:submit uri="/jsp/ボタン/確定ボタン.jsp" dummyUri="/jsp/ボタン/確定ボタン.jsp" label="確定ボタン"/></li>
          <li class="hover"><link:submit uri="/jsp/ボタン/削除ボタン.jsp" dummyUri="/jsp/ボタン/削除ボタン.jsp" label="削除ボタン"/></li>
