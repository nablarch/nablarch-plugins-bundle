...
<n:set var="defaultPattern" value="PATTERN01" scope="page" />
<%-- 明示的に指定しなかった場合に使用するオプション名称のカラム名 --%>
<n:set var="defaultOption" value="OPTION01" scope="page" />
<%-- 明示的に指定しなかった場合に使用するラベルコード --%>
<n:set var="defaultLabel" value="$NAME$" scope="page" />

<n:set var="sortable" value="${(empty sortable) ? 'false' : sortable}" scope="page" />
