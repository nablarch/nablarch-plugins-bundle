...
--%>
<n:set var="col"             value="${not empty titleSize ? titleSize - 2 : ''}" scope="page" />
<n:set var="labelGridMarker" value="${not empty titleSize ? 'grid-col-' : ''}" scope="page" />
<n:set var="labelGridCol"    value="${labelGridMarker}${col}" scope="page" />
<n:set var="inputGridMarker" value="${not empty inputSize ? 'grid-col-' : ''}" scope="page" />
<n:set var="inputGridCol"    value="${inputGridMarker}${inputSize}" scope="page" />
<n:set var="inputField"      value="${inputField == 'true' ? 'true' : 'false'}" scope="page" />
